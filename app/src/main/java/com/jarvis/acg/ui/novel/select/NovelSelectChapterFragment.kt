...
class NovelSelectChapterFragment : BookSelectChapterFragment<Novel, NovelSelectChapterViewModel>() {
    ...
    override fun getViewModelClass(): Class<NovelSelectChapterViewModel> { return NovelSelectChapterViewModel::class.java }
}